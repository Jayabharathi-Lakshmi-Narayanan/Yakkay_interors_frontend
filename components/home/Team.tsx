    ...
    <section id="team" className="section-padding bg-gray-50">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-sm uppercase tracking-wider text-ruby-green-500 font-medium mb-3">Our Team</h2>
          <h3 className="text-3xl md:text-4xl font-serif font-bold mb-6">
            Meet The <span className="gold-text">Experts</span> Behind Our Designs
          </h3>
          <p className="text-gray-600">
            Our talented team brings together diverse skills and perspectives to create 
            exceptional spaces that exceed client expectations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member) => (
            ...
            >
              ...
              <div className="p-6">
                <h4 className="font-serif font-semibold text-xl mb-1">{member.name}</h4>
                <p className="text-ruby-green-500 text-sm mb-3">{member.role}</p>
